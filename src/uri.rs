...
use crate::if_downcast_into;

use crate::uri::scheme::SchemeInner;

pub use crate::uri::authority::Authority;
pub use crate::uri::builder::Builder;
pub use crate::uri::path::PathAndQuery;
pub use crate::uri::port::Port;
pub use crate::uri::scheme::Scheme;
...
fn parse_full(mut s: Bytes) -> Result<Uri, InvalidUri> {
    // Parse the scheme
    let scheme = match SchemeInner::parse(&s[..])? {
        SchemeInner::None => SchemeInner::None,
        SchemeInner::Standard(p) => {
            // TODO: use truncate
